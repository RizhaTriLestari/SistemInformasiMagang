...
<body background="img/bg/undip.png">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Informasi Magang Mahasiswa</a>
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="jurusan" name="jurusan">
                                   ...
                                   <option value="Mesin" <?php if ($siswa['jurusan'] == 'Mesin') { ?> selected=''
                                        <?php } ?>>Mesin</option>
								  <option value="Akuntansi" <?php if ($siswa['jurusan'] == 'Akuntansi') { ?> selected=''
                                        <?php } ?>>Akuntansi</option>	
									<option value="Manajemen" <?php if ($siswa['jurusan'] == 'Manajemen') { ?> selected=''
                                        <?php } ?>>Manajemen</option>
                              </select>
                         </div>
                         <div class="mb-3">
                              <label for="email" class="form-label">Lama Magang</label>
                              <input type="email" class="form-control w-50" id="email" value="<?= $siswa['email']; ?>"
                                   name="email" autocomplete="off" required>
                         </div>
                         <div class="mb-3">
                              <label for="gambar" class="form-label">Foto Diri <i>(Saat ini)</i></label> <br>
                              <img src="img/<?= $siswa['gambar']; ?>" width="50%" style="margin-bottom: 10px;">
                              <input class="form-control form-control-sm w-50" id="gambar" name="gambar" type="file">
                         </div>
                         <div class="mb-3">
                              <label for="alamat" class="form-label">Posisi Magang</label>
